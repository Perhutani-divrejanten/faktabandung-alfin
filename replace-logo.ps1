...
$WorkspaceRoot = "c:\KULIAH\MAGANG\Magang di Perhutani\Fakta bandung"
$htmlFiles = Get-ChildItem -Path $WorkspaceRoot -Recurse -Include "*.html" -File

$textBasedLogo = @"
<span style="font-weight: bold; color: #2563EB; font-size: 24px; letter-spacing: -0.5px;">WARTA<span style="color: #5C3D1A; font-weight: normal; font-size: 18px; margin-left: 2px;">JANTEN</span></span>
"@
