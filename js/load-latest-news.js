...
async function loadLatestNews() {
    try {
        ...
        // Fallback: tampilkan pesan error di container
        const latestNewsRow = document.getElementById('latestNewsRow');
        if (latestNewsRow) {
            latestNewsRow.innerHTML = '<div class="col-12"><div class="alert alert-warning">Gagal memuat berita terbaru. Silakan refresh halaman.</div></div>';
        }
    }
}
