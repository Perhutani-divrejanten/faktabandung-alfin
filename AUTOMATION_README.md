...
- **email**: Email portal (akan replace "faktabandung@gmail.com")
- **socialHandle**: Handle social media (akan replace "faktabandung")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #2563EB → custom)
  - **dark**: Warna gelap hitam (contoh: #1E293B → custom)
...
| `faktabandung` | `siteName` (tanpa spaces) |
| `faktabandung` | `socialHandle` |
| `faktabandung@gmail.com` | `email` |
| `#2563EB` (primary) | Warna primary dari config |
| `#1E293B` (dark) | Warna dark dari config |
| `#5C3D1A` (secondary) | Warna secondary dari config |
